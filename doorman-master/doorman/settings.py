...
class Config(object):
    ...
    #CELERY_RESULT_BACKEND = 'redis://:manager@localhost:6379/0?ssl_cert_reqs=D:/doorman-master/certificate.crt'
    ...
    DOORMAN_LOGGING_FILENAME = 'D:/doorman-master/doorman/doorman.log'
